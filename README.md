...
This project is free and open source, but if you're feeling generous and would like to Toss A Coin to your Coder (try explaining that one when somebody reads this in five years!), there a a couple of ways to do so:
...
- Use this [Amazon link](https://amzn.to/3kGDqgc) when you're planning to make a purchase from the giant evil megacorp.
